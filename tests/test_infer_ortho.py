...
def test_infer_ortho():
    ...
    with open("tests/test_data/ortholog_trees/unpruned/dup_ortho1.tre", "r") as f:
    ...
    with open("tests/test_data/ortholog_trees/unpruned/dup_difficult_ortho1.tre", "r") as f:
    ...
    with open("tests/test_data/ortholog_trees/unpruned/dup_bl_ortho1.tre", "r") as f:
...
def test_infer_ortho_rooting(capsys):
    ...
    with open("tests/test_data/ortholog_trees_rooting/unpruned/outgroup2_ortho1.tre", "r") as f:
